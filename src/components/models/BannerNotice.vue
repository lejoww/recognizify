    ...
    <div class="heroesBannerNotice">
        <div style="width: 80%;display: flex; flex-direction: row; align-items: center">
            ...
            <div style="display: flex; flex-direction: column; margin-left: 0.4rem">
                <h2 class="heroesBannerTitle"><small class="badge badge-warning badge-small">Artículo semanal</small> {{this.article.title}}</h2>
                <span class="heroesBannerMotivation">{{article.abstract}}</span>
            </div>
        </div>
